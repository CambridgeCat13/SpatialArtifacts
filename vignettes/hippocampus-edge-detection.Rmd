...
The following code will install the latest release version of the `SpatialArtifacts` package from Bioconductor. Additional details are shown on [Bioconductor](https://bioconductor.org/packages/SpatialArtifacts).
